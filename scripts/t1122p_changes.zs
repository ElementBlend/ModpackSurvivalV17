...
// Fragmented Carbon recycle
recipes.addShapeless(<minecraft:coal:1>,
										[<galacticraftplanets:carbon_fragments>, <galacticraftplanets:carbon_fragments>, <galacticraftplanets:carbon_fragments>, <galacticraftplanets:carbon_fragments>]);